...
<h1 align="center">Hi 👋, I'm Karthikeyan L N R</h1>

<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Poppins&size=28&duration=3000&color=00F7FF&center=true&vCenter=true&width=700&lines=Data+Analytics+Enthusiast;Python+Developer;Power+BI+%26+SQL;Full+Stack+Learner;Building+Data-Driven+Solutions" />
</p>
# Hi, I'm Karthikeyan L N R 👋

💻 Computer Science Undergraduate passionate about Data Analytics, Python Development, and Scalable Applications.

📊 Skilled in building dashboards, integrating APIs, processing datasets, and developing data-driven solutions.
...
- Implemented backend workflows and structured database management
- Designed an intuitive user interface with efficient data processing workflows
- Improved usability and responsiveness through optimized application logic

---

## 📈 Retail Sales Analysis Dashboard
- Processed and analyzed retail datasets using Python, SQL, and Power BI
- Built KPI dashboards and customer behavior visualizations
- Automated reporting workflows
- Applied exploratory data analysis techniques to derive actionable business insights
...
Amrita Vishwa Vidyapeetam (2022 – 2026)  
CGPA: **7.71 / 10**
